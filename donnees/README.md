...
## recettes.json
165 recettes du quotidien (petit-déj / déjeuner / dîner / collation). `aliment_id` pointe vers aliments.json. Macros recalculées par l’app.
