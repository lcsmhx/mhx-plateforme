...
- **État en ligne** : **v43** (25/09/2026, poussée par Claude Code : correctif d'affichage côté coach — compte sans nom affiché « Sans nom », « Jamais rien saisi » classé à part ; avant : v42 `92f84f3` phase 20, v41 phase 13, v40 phase 16, v39 phase 15, v38 `4277f6a`, 37.1 `4b35c81` correctif de sécurité). **Les 20 phases sont faites.** Reste à Lucas : ses vérifications à l'écran (§11) et, quand il le décide, l'ouverture de l'inscription publique (prérequis en §7).
...
- **Les 20 phases sont faites** (v42, 25/09/2026). Blocs A (10 + 18, v38), B (15, v39), C (16, v40), D (13, v41) et la phase 20 (v42), chacun avec backup vérifié, comptages avant/après et relecture par un sous-agent indépendant avant la migration et le push. **v43** (25/09/2026, sans base) : deux défauts d'affichage relevés par Lucas — un compte sans prénom ni nom s'affiche « Sans nom » partout (`Clients.nom`, `Clients.avatar`) au lieu de son identifiant ; un compte qui n'a jamais rien saisi a son encadré « Jamais rien saisi » dans Mes clients et ne compte plus dans « Sans nouvelles depuis 10 jours ou plus ».
...
3. Installer le banc de test (`tests-locaux/README.md`) et le lancer sur la version en ligne : attendu v43 = 64 pages, 0 erreur, 19 + 13 + 14 + 13 + 15 + 67 vérifications, verif-xss 5/5, verif39 35/35, verif40 26/26, verif41 25/25, verif42 20/20, verif43 34/34, toutes réussies (voir §8).
